...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYOUT_QWERTY] = LAYOUT_ortho_5x15(
      KC_GRV,   KC_1,   KC_2,     KC_3,     KC_4,   KC_5,    KC_MINS,  KC_NLCK,  KC_EQL,   KC_6,    KC_7,   KC_8,     KC_9,     KC_0,     KC_BSPC,
      ...
      KC_LCTL,  MO(4),  KC_LGUI,  KC_LALT,  MO(2),  KC_SPC,  KC_PDOT,  KC_P0,    KC_COMM,  KC_SPC,  MO(3),  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT
      ),
  ...
  [2] = LAYOUT_ortho_5x15(
      KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    _______,  LWIN(KC_L),  _______,  KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,
